...
function WhatWeDo() {
  const b = window.HU_BASE || '';
  const cards = [
    { icon: 'users',     h: 'Club Champions',   p: 'Found a Heads Up club at your school and lead the change locally.',              cta: 'Start a club',     href: b + 'initiatives.html' },
    { icon: 'megaphone', h: 'Ambassadors',       p: 'A flexible role for students who want to help without running a club.',          cta: 'Join in',          href: b + 'initiatives.html' },
    { icon: 'heart',     h: 'Mentor Program',    p: 'Guide a middle schooler — or get guided — toward healthier tech habits.',        cta: 'Mentor or mentee', href: b + 'mentor-program.html' },
    { icon: 'bookOpen',  h: 'Learning Modules',  p: 'Explore 10+ digital-wellness topics and earn a certification.',                  cta: 'Explore',          href: b + 'initiatives.html' },
  ];
  return (
      ...
      <div className="wrap">
        <Reveal>
          <div className="mission">
            <img className="bgmark" src={b + 'assets/logo-mark-white.png'} alt="" />
