...
function Footer() {
  ...
  const cols = [
    { h: 'Heads Up', items: [
      { t: 'Home',          href: homeHref },
      { t: 'About',         href: b + 'index.html' },
      { t: 'Initiatives',   href: b + 'initiatives.html' },
      { t: 'Mentor Program',href: b + 'mentor-program.html' },
    ] },
    { h: 'Get involved', items: [
      { t: 'Start a club',    href: b + 'initiatives.html' },
      { t: 'Become a mentor', href: b + 'mentor-program.html' },
      { t: 'Partners',        href: b + 'partners.html' },
      { t: 'Donate',          href: '#' },
    ] },
  ];
  return (
        ...
        <div className="footer-grid">
          <div>
            <a className="brand" href={homeHref}>
              <img src={b + 'assets/logo-mark-white.png'} alt="Heads Up" style={{ height: 30 }} />
